...
C {/foss/designs/DeltaSigma/1-bit_DAC.sym} 490 -320 0 1 {name=x4}
C {devices/gnd.sym} 640 -280 0 0 {name=l14 lab=GND}
C {devices/vdd.sym} 640 -360 0 0 {name=l15 lab=VDD}
C {devices/gnd.sym} 520 -250 0 0 {name=l16 lab=GND}
C {devices/vdd.sym} 520 -390 0 0 {name=l17 lab=VDD}
C {sky130_stdcells/inv_1.sym} 260 -320 2 0 {name=x5 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {devices/vsource.sym} -80 -110 0 0 {name=V4 value="sin(0.9 0.9 5e3)" savecurrent=false}
C {devices/gnd.sym} -80 -80 0 1 {name=l18 lab=GND}
C {devices/lab_pin.sym} -80 -140 1 0 {name=p3 sig_type=std_logic lab=SIG}
C {devices/capa.sym} 190 -240 1 0 {name=C1
m=1
value=60p
footprint=1206
device="ceramic capacitor"}
C {devices/capa.sym} 450 -240 1 0 {name=C2
m=1
value=60p
footprint=1206
device="ceramic capacitor"}
