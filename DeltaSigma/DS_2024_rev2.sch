...
device=resistor
m=1}
C {/foss/designs/dsigma2024/c2s2_amp_f_i.sym} 140 -120 0 0 {name=x1}
C {/foss/designs/dsigma2024/c2s2_amp_f_i.sym} 400 -120 0 0 {name=x2}
...
C {/foss/designs/dsigma2024/1-bit_C_ADC.sym} 610 10 0 0 {name=x3}
...
C {/foss/designs/dsigma2024/1-bit_DAC.sym} 490 -320 0 1 {name=x4}
