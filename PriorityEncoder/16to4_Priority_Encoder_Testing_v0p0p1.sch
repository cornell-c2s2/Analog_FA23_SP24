...
C {devices/code_shown.sym} -650 90 0 0 {name=s1 
only_toplevel=false 
value="
.control
save all
tran 50p 400n
write 16to4_Priority_Encoder_Testing_v0p0p1.raw
...
C {devices/lab_pin.sym} -440 275 0 0 {name=p20 sig_type=std_logic lab=VDD}
...
C {devices/lab_pin.sym} -440 315 0 0 {name=p47 sig_type=std_logic lab=IN15}
C {devices/lab_pin.sym} -440 415 0 0 {name=p48 sig_type=std_logic lab=IN10}
C {devices/lab_pin.sym} -440 435 0 0 {name=p49 sig_type=std_logic lab=IN9}
C {devices/lab_pin.sym} -440 535 0 0 {name=p50 sig_type=std_logic lab=IN4}
C {devices/lab_pin.sym} -440 555 0 0 {name=p51 sig_type=std_logic lab=IN3}
...
C {devices/lab_pin.sym} -440 335 0 0 {name=p24 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} -440 355 0 0 {name=p25 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} -440 375 0 0 {name=p26 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} -440 395 0 0 {name=p27 sig_type=std_logic lab=GND}
